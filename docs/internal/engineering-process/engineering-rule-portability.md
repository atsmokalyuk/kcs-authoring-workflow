...
`d1c6f6d1af8442ce704cf57c07a28ec4ed6aec66`. Nine entries satisfied
...
source dispositions in `pre-kcs-16-ddd-evidence-review.md` and
`ENG-PORT-DEL-010` through `SR-DEL010-01`. Their generic assets and the
