...
| Aggregate design review | Slice 6 methodology | Completed after Slice 6 Batch 2 | Next required after two more refactor batches or an earlier methodology trigger. |
