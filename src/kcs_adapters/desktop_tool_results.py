...
def _pre_draft_tool_result_text(structured: Mapping[str, Any]) -> str | None:
    ...
    if structured.get("result_kind") == "semantic_review_packet":
        ...
        return (
            ...
            "allowed_source_refs in candidate_semantic_extraction_v1 output. Do "
            "not copy filesystem paths, log paths, command output, local paths, "
            "or raw transcript text into the submission. Do not add extra "
            "fields such as candidates, commands, log_file, service_names, or "
            "services_affected. The candidate array key must be items.\n\n"
...
def _semantic_review_blocked_tool_result_text(
    ...
    return (
        ...
        "reviewer-only draft was generated.\n\n"
        "Do not draft manually. For semantic-review submit errors, restart "
